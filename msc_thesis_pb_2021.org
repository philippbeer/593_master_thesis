...
#+LATEX_HEADER: \title{Efficient Algorithms for Time Series Retrieval}
...
\begin{center}
\doublespacing
{\huge \textbf{APPROVAL PAGE} \par}
Master of Science Thesis \par
{\fontsize{20}{30}\selectfont Efficient Algorithms for Time Series Retrieval \par}
Presented by \par
Philipp Beer \par
\end{center}
\vspace{2cm}
\begin{table}[bh]
\begin{tabular}{lc}
\makebox[2.5in]{Research Supervisor} & \makebox[2.5in]{\hrulefill}\\
 & Professor Ioannis Katakis\\[8ex]% adds space between the two sets of signatures
\makebox[2.5in]{Committee Member} & \makebox[2.5in]{\hrulefill}\\
 & Professor Spyros Makridakis\\[8ex]
\makebox[2.5in]{Committee Member} & \makebox[2.5in]{\hrulefill}\\
 & Professor Theodoros Moysiadis\\ [8ex]
\end{tabular}
\end{table}
\begin{center}
University of Nicosia \par
May, 2022
\end{center}

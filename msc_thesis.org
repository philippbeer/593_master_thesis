...
The next area of analysis is the value distribution of the individual series.


Another interesting area of comparison is the distribution of the two data repositories in the Fourier domain.
...
** Evalution Method
To evaluate the performance of the algorithm proposed in this work the following procedure was applied to the UCR time series data set. To generate the results with our the method the whole data set was transformed and augmented as described in section [[sec:methodology]]. After the transformation and stratified random sample of 1421 was chosen from the UCR test dataset, such that each different data category is represented.
...
[[./img/dtw_comp_res/PigAirwayPressure_127_ucr_dtw_fft_comp.png]]

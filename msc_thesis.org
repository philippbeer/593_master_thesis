...
Noteworthy is also the fact that the time complexity of the statistical metrics does


*** Matching of time series
<<sec:match_ts>>
After the completion of phase I the time series pool is ready for use. When a new time series is to be matched against the pool first the data transformation and computation of statistical metrics
